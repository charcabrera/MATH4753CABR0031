...
```
This function will calculate the mean of n*iter poisson samples of size n, and create a histogram of the means. Lambda is the lambda of the poisson distribution.
